                ...
                <div class="panel-body">
                    <div class="col-sm-6 col-md-6">
                            ...
                            <div class="mini-container">
                                <div class="nice-border">
                                    <form method="POST" action="" class="form-group p-a-sm">
                                        ...
                                        <br/>
                                        <input class="btn btn-info btn-block bg-custom" type="submit" name="submit" value="Update"/>
                                    </form>
                                </div>
                            </div>
                        ';
                        ...
                        echo'                    </label>
                                        ...
                                        <br/>
                                        <input class="btn btn-info btn-block bg-custom" type="submit" name="submit" value="Submit"/>
                                    </form>
                                </div>
                            </div>
                        ';
